...
class evadir_objectos:
    def __init__(self):
        ...
        #rospy.Subscriber("/zed/depth/depth_registered", sl.Mat, self.callback_zed_depth) #changed Image to 10
        #rospy.Subscriber("/zed/rgb/image_rect_color", sl.Mat, self.callback_zed_img) #changed Image to 10

        #rospy.Subscriber("/velodyne_points", PointCloud2, self.callback_zed_cp)
        rospy.Subscriber("/zed2/zed_node/point_cloud/cloud_registered", PointCloud2, self.callback_zed_cp)
